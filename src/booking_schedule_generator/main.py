...
import locale
import calendar
from data import appartments, seasons
...
for i in range(0, 12):
    ...
    block.price_block(start_col=1, start_row=4, appartment=appartments["wg_1"])
    block.price_block(start_col=1, start_row=10, appartment=appartments["wg_2"])
    block.price_block(start_col=1, start_row=16, appartment=appartments["wg_3"])
    block.price_block(start_col=1, start_row=22, appartment=appartments["wg_4"])
    block.price_block(start_col=1, start_row=28, appartment=appartments["wg_5"])
    block.price_block(start_col=1, start_row=34, appartment=appartments["wg_6"])
